...
function program1(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "_endpoint_list' style='display:none'>\n</ul>\n<div class='swagger-ui-pager' style='display: none; margin-bottom: 6px;'></div>\n";
  return buffer;
  });
})();
...
(function() {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
templates['resource_pager'] = template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
...
function program1(depth0,data) {
  ...
  var buffer = "", stack1, stack2;
  buffer += "\n  <option value='"
    + escapeExpression(((stack1 = depth0.num),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "' ";
...
function program2(depth0,data) {
  ...
  buffer += "<span>page no:</span>\n<select class='swagger-select-pager'>\n";
  options = {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data};
  stack2 = ((stack1 = helpers.pages || depth0.pages),stack1 ? stack1.call(depth0, depth0.pageTotal, depth0['q'], options) : helperMissing.call(depth0, "pages", depth0.pageTotal, depth0['q'], options));
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n</select>\n<span style=\"margin-left:12px;\">page total: <b>";
  if (stack2 = helpers.pageTotal) { stack2 = stack2.call(depth0, {hash:{},data:data}); }
  else { stack2 = depth0.pageTotal; stack2 = typeof stack2 === functionType ? stack2.apply(depth0) : stack2; }
...
(function() {
  ...
  ResourceView = (function(_super) {
    ...
    ResourceView.prototype.addOperation = function(operation) {
      ...
      if (this.number >= ((this.pageNum - 1) * this.pageSize) && this.number < (this.pageNum * this.pageSize)) {
